              ...
              <div class="row">
                ...
                <div>
                  <ul class="nav nav-pills nav-secondary nav-pills-no-bd" id="pills-tab-without-border" role="tablist">
                    ...
                    <li>
                      <a class="nav-link active" href="patient-recordfac.php" role="tab">Faculty</a>
                    </li>
                    <li>
                  ...
                  <div class="card">
                    ...
                    <div class="card-body">
                      ...
                      <div class="table-responsive">
                                ...
                                $faculties = $patientTables->getAllFaculties();
                                $counter = 1;
                                
                                foreach ($faculties as $faculty) {
                                    // Determine the status and color for each faculty
                                    $statusText = isset($faculty->faculty_status) && $faculty->faculty_status == 'Inactive' ? 'Disabled' : 'Enabled';
                                    $statusColor = isset($faculty->faculty_status) && $faculty->faculty_status == 'Inactive' ? '#ff6961' : '#77dd77';
                                    ...
                                    echo '<td>' . $faculty->faculty_role . '</td>';
                                    ...
                                    echo '<td> 
                                        <div class="form-button-action">
                                            <button type="submit" class="btn btn-link btn-primary btn-lg viewButton" 
                                                    data-id="' . $faculty->patient_id . '" data-type="'. $faculty->patient_type .'">
                                                <i class="fa fa-eye"></i>
                                            </button>
