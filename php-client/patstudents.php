...
$sex = $studentData['patient']['patient_sex'];
$address = "{$studentData['address']['address_prkstrtadd']}, 
    {$studentData['address']['address_barangay']}, 
    {$studentData['address']['address_municipality']}, 
    {$studentData['address']['address_province']}, 
    {$studentData['address']['address_region']}";
$email = $studentData['patient']['patient_email'];
$contactNumber = $studentData['patient']['patient_connum'];
$emergencyContactName = $studentData['emergencyContact']['emcon_conname'];
$emergencyContactNumber = $studentData['emergencyContact']['emcon_connum'];
$status = $studentData['patient']['patient_status'];
    ...
    <div class="row"> 
        ...
        <div class="profile-image">
            ...
            <div class="row" style="display: flex; flex-direction: column; align-items: center; text-align: center;">
                <h5 style="color: #59535A; margin: 0;">#<?php echo $studentID; ?></h5>
                <h5 style="margin: 0;">
        ...
        Swal.fire({
            ...
            willClose: () => {
                if (status === 'success') {
                    ...
                    window.location.href = "patstudents.php";
                }
            }
        });
