...
$staffData = $patient->getstaffData($patient_id);

$profilePic = $staffData['patient']['patient_profile'];
$staffID = $staffData['staff']['staff_idnum'];
$lastName = $staffData['patient']['patient_lname'];
$firstName = $staffData['patient']['patient_fname'];
$middleName = $staffData['patient']['patient_mname'];
$office = $staffData['staff']['staff_office'];
$role = $staffData['staff']['staff_role'];
$dob = $staffData['patient']['patient_dob'];
$sex = $staffData['patient']['patient_sex'];
$address = "{$staffData['address']['address_prkstrtadd']}, 
    {$staffData['address']['address_barangay']}, 
    {$staffData['address']['address_municipality']}, 
    {$staffData['address']['address_province']}, 
    {$staffData['address']['address_region']}";
$email = $staffData['patient']['patient_email'];
$contactNumber = $staffData['patient']['patient_connum'];
$emergencyContactName = $staffData['emergencyContact']['emcon_conname'];
$emergencyContactNumber = $staffData['emergencyContact']['emcon_connum'];
$status = $staffData['patient']['patient_status'];
    ...
    <div class="main-panel" id="clientpanel">
      ...
      <div class="container" id="content">
        ...
        <div class="profile-image">
            ...
            <img id="profilePic" src="/php-admin/uploads/<?php echo $profilePic; ?>" alt="profile picture" />  
                <div class="row" >                
                    <span style="
            ...
            <div class="row" style="display: flex; flex-direction: column; align-items: center; text-align: center;">
                <h5 style="color: #59535A; margin: 0;">#<?php echo $staffID; ?></h5>
                <h5 style="margin: 0;">
                ...
                <h5 style="color: #59535A; margin: 0;"> <?php echo $office; ?></h5>
        ...
        Swal.fire({
            ...
            willClose: () => {
                if (status === 'success') {
                    ...
                    window.location.href = "patstaff.php";
                }
            }
        });
