...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_POST['patient_id']) && isset($_FILES['addprofile']) && $_FILES['addprofile']['error'] === UPLOAD_ERR_OK) {
        ...
        if (in_array($mime, $allowed_mimes)) {
            ...
            if (move_uploaded_file($profile_tmp, $profile_destination)) {
                ...
                $sql_update = "UPDATE patients SET patient_profile = :profile_name WHERE patient_id = :patient_id";
